...
import edu.neu.coe.info6205.sort.BaseHelper.HelperException;
...
public class BaseeHelper<X extends Comparable<X>> implements Helper<X> {
     ...
     */
    public BaseeHelper(String description, int n, Random random) {
        this.n = n;
     ...
     */
    public BaseeHelper(String description, int n, long seed) {
     ...
     * @param n           the number of elements expected to be sorted. The field n is mutable so can be set after the constructor.
     */
    public BaseeHelper(String description, int n) {
     ...
     * @param description the description of this Helper (for humans).
     */
    public BaseeHelper(String description) {
        this(description, 0);
    }
